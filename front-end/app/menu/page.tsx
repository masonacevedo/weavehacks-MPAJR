      ...
      <div className={styles.appContainer}>
        <div className={styles.mainMenu} id="mainMenu">
          ...
          <div className={styles.navigation}>
            <div className={styles.navItem} onClick={() => showContent('account')}>
              ACCOUNT
            </div>
            <div className={styles.navItem} onClick={() => showContent('posts')}>
              POSTS
            </div>
            <div className={styles.navItem} onClick={() => showContent('contact')}>
              CONTACT US
            </div>
          </div>
        </div>
        ...
        {/* Content Areas */}
        <div className={styles.contentArea} id="accountContent">
          ...
          <button className={styles.backBtn} onClick={() => showMainMenu()}>Back to Main Menu</button>
        </div>

        <div className={styles.contentArea} id="postsContent">
        ...
        <div className={styles.contentArea} id="contactContent">
          <h2>Contact Us</h2>
          ...
          <div className={styles.lodgeInformation}>
          ...
          <div className={styles.lodgeOfficers}>
